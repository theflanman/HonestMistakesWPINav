...
public class Constants {
	...
	public static final String SCALES_PATH = "src/data/mapScales.yml"; // scales path
	
	// images
	public static final String DEFAULT_MAP_IMAGE = "Complete_Campus_Map.JPG"; // default map
