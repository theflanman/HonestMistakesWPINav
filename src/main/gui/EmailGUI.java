...
public class EmailGUI extends JDialog {
	...
	public static void main(String[] args) {
		try {
			final EmailGUI dialog = new EmailGUI();
	...
	public EmailGUI() {
		...
		// Subject label
		final JLabel lblSubject = new JLabel("Subject:");
		...
		// Top bar text
		final JLabel lblNewLabel = new JLabel("Email Directions");
		...
		final JTextArea txtBody = new JTextArea();
		...
		// Send Button
				...
				btnSend.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						body = body.concat("\n").concat(directions);
						final String[] toEmail = txtTo.getText().split(";");
